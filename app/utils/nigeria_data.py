...
Contains all 36 States + Federal Capital Territory (FCT) and their LGAs.
"""
...
NIGERIA_STATES_AND_LGAS = {
    ...
    "FCT Abuja": [
        "Abaji", "Abuja Municipal Area Council (AMAC)", "Bwari", "Gwagwalada", "Kuje", "Kwali"
    ],
    "Gombe": [
    ...
    "Kano": [
        ...
        "Garun Mallam", "Gaya", "Gezawa", "Gwale", "Karaye", "Kibiya", "Kano Municipal",
    ...
    "Kwara": [
        "Asa", "Baruten", "Edu", "Ekiti", "Isin", "Ilorin East", "Ilorin South",
        "Ilorin West", "Irepodun", "Kaiama", "Moro", "Offa", "Oke Ero", "Oyun", "Pategi"
    ],
    "Lagos": [
        "Agege", "Ajeromi-Ifelodun", "Alimosho", "Amuwo-Odofin", "Badagry", "Epe",
    ...
    "Ogun": [
        ...
        "Ikenne", "Remo North", "Imeko Afon", "Ipokia", "Obafemi Owode", "Odogbolu",
        "Odeda", "Ogun Waterside", "Shagamu"
    ],
    "Ondo": [
    ...
    "Oyo": [
        ...
        "Ibarapa Central", "Ibarapa East", "Ibarapa North", "Iddo", "Iseyin",
...
def get_nigerian_states():
    """Return a sorted list of all Nigerian States + FCT."""
...
def get_lgas_for_state(state_name):
    ...
    return sorted(NIGERIA_STATES_AND_LGAS.get(state_name, []))
